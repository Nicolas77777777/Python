...
def AutoVenduta():
    ...
    posizione = input("Dove è locata? ")
    filiale_id = input("Inserisci la filiale id: ")
    condizione = input("Qual'è lo stato della vettura? ")
    autoVenduta = {"id":id, "marca":marca, "modello": modello, "colore": colore, "posizione":posizione, "filiale_id":filiale_id, "condizione": condizione}
    return autoVenduta
