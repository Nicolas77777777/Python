...
# number of book titles authored by them. This function should return a dictionary 
# where the author's name is the key and the value is a list of their books.
...
# Write a function called delete_book() that accepts a dictionary and the name of the 
# author from whom to remove all details. This function should return an updated dictionary.

# Example: delete_book(dictionary, “Mark Twain”)

# 3. Personal Info:

# Write a build_profile() function that accepts the name , surname,  occupation,
# location, and age  of a person. Make occupation, location, and age optional parameters.
...
# and an hour. The function should return a dictionary that includes the event name and 
# a list of the participants. Call this function with varying numbers of participants 
# to plan different events.
...
# Write a function called create_shopping_list() that accepts a store name and 
# any number of items as arguments. It should return a dictionary with the store
...
# Write a function called print_shopping_list() that accepts a dictionary and a store 
# name, then prints each item from that store's shopping list.
